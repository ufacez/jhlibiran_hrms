...
requirePermission($db, 'can_edit_attendance', 'You do not have permission to edit attendance');
...
if ($attendance_id <= 0) {
    ...
    redirect(BASE_URL . '/modules/admin/attendance/index.php');
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            ...
            redirect(BASE_URL . '/modules/admin/attendance/index.php?date=' . $attendance['attendance_date']);
