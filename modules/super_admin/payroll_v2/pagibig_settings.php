...
// Allow admin with Pag-IBIG view permission to see this page
requireAdminWithPermission($db, 'can_view_pagibig', 'You do not have permission to view Pag-IBIG settings');

// Check if user can edit (super_admin or has can_edit_pagibig permission)
$user_level = getCurrentUserLevel();
$can_edit = ($user_level === 'super_admin') || hasPermission($db, 'can_edit_pagibig');
