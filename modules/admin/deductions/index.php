<?php
/**
 * Admin Deductions Management - Permission-Based
...
// Check permission
requirePermission($db, 'can_view_deductions', 'You do not have permission to view deductions');

$can_manage = hasPermission($db, 'can_manage_deductions');
$full_name = $_SESSION['full_name'] ?? 'Administrator';
$flash = getFlashMessage();

// Handle delete action (only if has manage permission)
if ($can_manage && isset($_POST['delete_deduction'])) {
...
// Handle toggle active/inactive (only if has manage permission)
if ($can_manage && isset($_POST['toggle_deduction'])) {
    $deduction_id = intval($_POST['deduction_id']);
        ...
        <div class="main">
            ...
            <div class="workers-content">
                ...
                <div class="alert alert-info">
                    ...
                    <span>You have view-only access to deductions. Contact your administrator to manage deductions.</span>
                </div>
                <?php endif; ?>
                    ...
                    <div class="table-wrapper">
                        <table class="workers-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="<?php echo $can_manage ? '7' : '6'; ?>" class="no-data">
