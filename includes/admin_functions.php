    ...
    try {
        ...
        if (!$admin) {
            ...
            return [
                ...
                'can_view_biometric' => false,
                'can_manage_biometric' => false,
        ...
        return [
            ...
            'can_view_biometric' => (bool)($permissions['can_view_biometric'] ?? 0),
            'can_manage_biometric' => (bool)($permissions['can_manage_biometric'] ?? 0),
            'can_register_face' => (bool)($permissions['can_register_face'] ?? 0),
