...
// Allow admin with BIR view permission to see this page
requireAdminWithPermission($db, 'can_view_bir', 'You do not have permission to view BIR (tax) settings');

// Check if user can edit (super_admin or has can_edit_bir permission)
$user_level = getCurrentUserLevel();
$can_edit = ($user_level === 'super_admin') || hasPermission($db, 'can_edit_bir');
