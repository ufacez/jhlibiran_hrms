...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_permissions'])) {
    try {
        ...
        $all_permissions = [
            ...
            'can_view_biometric', 'can_manage_biometric', 'can_register_face',
                ...
                <form method="POST" action="">
                    ...
                    <div class="form-card">
                        ...
                        <div class="permissions-grid">
                            ...
                            <div class="permission-item" onclick="toggleCheckbox('can_register_face')">
                                <input type="checkbox" name="can_register_face" id="can_register_face" value="1"
                                       <?php echo ($permissions['can_register_face'] ?? 0) ? 'checked' : ''; ?>>
                                <label for="can_register_face">Register Face (Launch Device)</label>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        function toggleSection(section) {
            const sections = {
                ...
                'biometric': ['can_view_biometric', 'can_manage_biometric', 'can_register_face'],
